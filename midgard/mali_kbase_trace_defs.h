 ...
 */
	...
	/************ TZGPU custom trace *****************/
	// jin: add custom trace 
	KBASE_TRACE_CODE_MAKE_CODE(JIN_PM_START),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_PM_DONE),
	// KBASE_FOPS
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_FOPS_OPEN),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_FOPS_RELEASE),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_FOPS_READ),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_FOPS_POLL),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_FOPS_MMAP),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_FOPS_CHECK_FLAGS),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_FOPS_GET_UNMAPPED_AREA),
	// xzl: info_val == fops. 0==open, etc.
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_FOPS_DONE),
	// KBASE_PM_OPS
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_PM_OPS_DEVICE_SUSPEND),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_PM_OPS_DEVICE_RESUME),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_PM_OPS_DEVICE_RUNTIME_SUSPEND),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_PM_OPS_DEVICE_RUNTIME_RESUME),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_PM_OPS_DONE),
	// jin: info_val == pm_ops. 0==suspend, etc.
	// KBASE_VM_OPS
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_VM_OPS_OPEN),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_VM_OPS_CLOSE),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_VM_OPS_FAULT),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_VM_OPS_DONE),
	// jin: info_val == vm_ops. 0==open, etc.
	// KBASE_IOCTL
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_IOCTL_VERSION_CHECK),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_IOCTL_SET_FLAGS),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_IOCTL_JOB_SUBMIT),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_IOCTL_GET_GPUPROPS),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_IOCTL_POST_TERM),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_IOCTL_MEM_ALLOC),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_IOCTL_MEM_QUERY),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_IOCTL_MEM_FREE),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_IOCTL_DISJOINT_QUERY),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_IOCTL_GET_DDK_VERSION),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_IOCTL_MEM_JIT_INIT_OLD),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_IOCTL_MEM_JIT_INIT),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_IOCTL_MEM_EXEC_INIT),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_IOCTL_MEM_SYNC),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_IOCTL_MEM_FIND_CPU_OFFSET),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_IOCTL_MEM_FIND_GPU_START_AND_OFFSET),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_IOCTL_GET_CONTEXT_ID),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_IOCTL_TLSTREAM_ACQUIRE),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_IOCTL_TLSTREAM_FLUSH),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_IOCTL_MEM_COMMIT),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_IOCTL_MEM_ALIAS),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_IOCTL_MEM_IMPORT),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_IOCTL_MEM_FLAGS_CHANGE),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_IOCTL_STREAM_CREATE),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_IOCTL_FENCE_VALIDATE),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_IOCTL_MEM_PROFILE_ADD),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_IOCTL_SOFT_EVENT_UPDATE),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_IOCTL_STICKY_RESOURCE_MAP),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_IOCTL_STICKY_RESOURCE_UNMAP),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_IOCTL_HWCNT_READER_SETUP),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_IOCTL_HWCNT_ENABLE),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_IOCTL_HWCNT_DUMP),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_IOCTL_HWCNT_CLEAR),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_IOCTL_GET_CPU_GPU_TIMEINFO),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_IOCTL_HWCNT_SET),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_IOCTL_CINSTR_GWT_START),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_IOCTL_CINSTR_GWT_STOP),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_IOCTL_CINSTR_GWT_DUMP),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_IOCTL_TLSTREAM_TEST),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_IOCTL_TLSTREAM_STATS),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_KBASE_IOCTL_DONE),
	// ************************** eof kbase_ioctl 
	KBASE_TRACE_CODE_MAKE_CODE(JIN_MMU_OP_START),
	KBASE_TRACE_CODE_MAKE_CODE(JIN_MMU_OP_DONE),
	/*************** End of TZGPU custom trace *********************/
